...
function keyFunc(){
 window.alert("The key was pressed");
...
function changingDivStyles(){
  ...
  button3.style.color = "purple"; // CHANGES INLINE STYLING
  button3.style.fontWeight = "700"; // NON IDEAL WAY OF CHANGING STYLE THROUGH JS

  button3.classList.add("button_clicked"); // BEST PRACTICE
  button3.classList.remove("not_clicked");
  //button3.classList.toggle("hjgjhg");
